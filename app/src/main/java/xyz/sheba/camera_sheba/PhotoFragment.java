...
public class PhotoFragment extends Fragment implements SurfaceHolder.Callback  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        llPreviewLayout = view.findViewById(R.id.llPreviewLayout);
        vBorderCamera = view.findViewById(R.id.vBorderCamera);
...
//        ButterKnife.bind(this, view);
        ...
        surfaceView = (SurfaceView) view.findViewById(R.id.svTransparentView);
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        if (camera != null) {
            try {
                ...
                //write some info
                int x1 = llPreviewLayout.getWidth();
                int y1 = llPreviewLayout.getHeight();

                int x2 = vBorderCamera.getWidth();
                int y2 = vBorderCamera.getHeight();
    ...
    Camera.PictureCallback myPictureCallback_JPG = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            if (display.getRotation() == Surface.ROTATION_0) {
                ...
                float koefX = (float) rotatedBitmap.getWidth() / (float) llPreviewLayout.getWidth();
                float koefY = (float) rotatedBitmap.getHeight() / (float) llPreviewLayout.getHeight();

                //get viewfinder border size and position on the screen
                int x1 = vBorderCamera.getLeft();
                int y1 = vBorderCamera.getTop();
